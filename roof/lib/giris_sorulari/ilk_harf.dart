...
class _FillMissingLetterState extends State<FillMissingLetter> {
  final List<Map<String, String>> wordData = [
    {"word": "pasta", "imageUrl": "assets/images/pasta.jpg"},
    {"word": "örümcek", "imageUrl": "assets/images/orumcek.jpg"},
    {"word": "tabak", "imageUrl": "assets/images/tabak.jpg"},
    {"word": "bebek", "imageUrl": "assets/images/bebek.jpg"},
    {"word": "tavuk", "imageUrl": "assets/images/tavuk.jpg"},
    {"word": "bulut", "imageUrl": "assets/images/bulut.jpg"},
  ];

  List<Map<String, String>> remainingWords = []; // Kullanılmamış kelimeler listesi
...
class ResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int incorrectAnswers = totalQuestions - correctAnswers; // Yanlış cevap sayısı
