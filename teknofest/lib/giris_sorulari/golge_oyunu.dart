...
class _WordShadowMatchGameState extends State<WordShadowMatchGame> {
  ...
  List<String> shuffledShadowImages =
      []; /*shuffledShadowImages adında bir
  ...
  String?
      selectedWord; //Kullanıcı bir kelimeyi seçtiğinde bu değişken bu kelimeyi tutar.
  String? selectedShadow; //bu da seçilen gölgeyi tutar.
  final Map<String, String> matches =
      {}; //matches, bir Map objesidir ve eşleşen kelimeler ile gölgeleri tutmak için kullanılır.
  ...
  void selectWord(String word) {
    //kelime seçimi yapıp veriyi tutmayı sağlıyo.
    setState(() {
      selectedWord = word;
  ...
  void selectShadow(String shadow) {
    //gölge seçimi yapmamızı ve seçimi tutmayı sağlıyo.
    setState(() {
  ...
  void checkMatch() {
    /*kullanıcının seçtiği kelime ve gölge resmi arasında
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //Scaffold widget'ı, temel materyal tasarımı ve uygulamanın ana iskeletini sağlar.
      appBar: AppBar(
        //uygulamada AppBar içinde "Kelimeleri Gölgeleriyle Eşleştirme" başlığı bulunur.
        title: const Text('Kelimeleri Gölgeleriyle Eşleştirme'),
      ),
      body: Padding(
        //içeriğin etrafına 16 birimlik iç boşluk ekler.
        padding: const EdgeInsets.all(16.0),
        child: Column(
          //Sütun şeklindeki bir düzen sağlar.
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            Expanded(
              //Ekranda kullanılabilir tüm dikey alanı kaplar. İçerisinde bir Column bulunur.
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: List.generate(words.length, (index) {
                  //List.generate  her kelime ve gölge resmi için dinamik olarak bir Row oluşturulur.
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          //kelimelere dokunulduğunda selectWord fonksiyonunu tetikler.
                            ...
                            color: matches[word] == 'wrong'
                                ...
                                : (matches[word] != null
                                    ...
                                    : (selectedWord == word
                                        ? Colors.blue
                                        : Colors.grey[
                                            300])), //sadece seçim sırasında mavi
                            child: Text(
                              word,
                      ...
                      const SizedBox(
                          width: 50), // Kelimeler ve gölgeler arasındaki boşluk
                      Expanded(
                        child: GestureDetector(
